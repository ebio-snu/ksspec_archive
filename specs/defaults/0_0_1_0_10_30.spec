{
  ...
  "Devices" : [
    { "Class" : "sensor", "Type" : "temperature-sensor", "Model" : "SEN-TEMP", "Name" : "온도센서1", "CommSpec" : { "KS X 3267" : { "read" : { "starting-register" : 203, "items": ["value", "status"] } } } }, 
    { "Class" : "sensor", "Type" : "temperature-sensor", "Model" : "SEN-TEMP", "Name" : "온도센서2", "CommSpec" : { "KS X 3267" : { "read" : { "starting-register" : 206, "items": ["value", "status"] } } } }, 
    { "Class" : "sensor", "Type" : "temperature-sensor", "Model" : "SEN-TEMP", "Name" : "온도센서3", "CommSpec" : { "KS X 3267" : { "read" : { "starting-register" : 209, "items": ["value", "status"] } } } }, 
    ...
    { "Class" : "sensor", "Type" : "quantum-sensor", "Model" : "SEN-QUAN", "Name" : "광량자센서", "CommSpec" : { "KS X 3267" : { "read" : { "starting-register" : 245, "items": ["value", "status"] } } } }, 
    ...
    { "Class" : "sensor", "Type" : "tensiometer", "Model" : "SEN-TEN", "Name" : "토양장력센서", "CommSpec" : { "KS X 3267" : { "read" : { "starting-register" : 251, "items": ["value", "status"] } } } }, 
    ...
    { "Class" : "sensor", "Type" : "temperature-sensor", "Model" : "SEN-TEMP", "Name" : "온도센서4", "CommSpec" : { "KS X 3267" : { "read" : { "starting-register" : 260, "items": ["value", "status"] } } } }, 
    { "Class" : "sensor", "Type" : "temperature-sensor", "Model" : "SEN-TEMP", "Name" : "온도센서5", "CommSpec" : { "KS X 3267" : { "read" : { "starting-register" : 263, "items": ["value", "status"] } } } }, 
    { "Class" : "sensor", "Type" : "temperature-sensor", "Model" : "SEN-TEMP", "Name" : "온도센서6", "CommSpec" : { "KS X 3267" : { "read" : { "starting-register" : 266, "items": ["value", "status"] } } } }, 
    { "Class" : "sensor", "Type" : "temperature-sensor", "Model" : "SEN-TEMP", "Name" : "온도센서7", "CommSpec" : { "KS X 3267" : { "read" : { "starting-register" : 269, "items": ["value", "status"] } } } }, 
    { "Class" : "sensor", "Type" : "temperature-sensor", "Model" : "SEN-TEMP", "Name" : "온도센서8", "CommSpec" : { "KS X 3267" : { "read" : { "starting-register" : 272, "items": ["value", "status"] } } } }, 
    { "Class" : "sensor", "Type" : "temperature-sensor", "Model" : "SEN-TEMP", "Name" : "온도센서9", "CommSpec" : { "KS X 3267" : { "read" : { "starting-register" : 275, "items": ["value", "status"] } } } }, 
    { "Class" : "sensor", "Type" : "temperature-sensor", "Model" : "SEN-TEMP", "Name" : "온도센서10", "CommSpec" : { "KS X 3267" : { "read" : { "starting-register" : 278, "items": ["value", "status"] } } } }, 
    { "Class" : "sensor", "Type" : "humidity-sensor", "Model" : "SEN-HUM", "Name" : "습도센서2", "CommSpec" : { "KS X 3267" : { "read" : { "starting-register" : 281, "items": ["value", "status"] } } } }, 
    { "Class" : "sensor", "Type" : "humidity-sensor", "Model" : "SEN-HUM", "Name" : "습도센서3", "CommSpec" : { "KS X 3267" : { "read" : { "starting-register" : 284, "items": ["value", "status"] } } } }, 
